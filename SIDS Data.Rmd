...
Do some exploratory analysis and graphing (all of this will have explinations in the final draft)
```{r}
...
The ICD 10 code for SIDS is GR130-135 so I will use it to make a subset of the data looking at only SIDS
...
summary(fit)
```
Well none of this is significant. There were MANY fewer observation in the SIDS subset than in the whole thing so that may be contributing.
...
Discussion.  
The git hub for this is located at ...